...
@frappe.whitelist(allow_guest=True)  # nosemgrep - the answer is what the caller may
# do and how to render for them, and a guest's answer says they may do nothing
def get_user_info():
