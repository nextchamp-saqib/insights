...
<template>
	<div>
		...
		<div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
			<div
				class="col-span-1 flex cursor-pointer items-center justify-between rounded border border-transparent bg-surface-white p-4 shadow transition-all hover:border-outline-gray-3"
				@click="openNewWorkbook"
			>
				<div class="text-lg font-medium text-ink-gray-9">{{ __('New Workbook') }}</div>
				<div class="rounded bg-surface-gray-2 p-1">
