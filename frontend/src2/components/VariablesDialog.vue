	...
	>
		<template #body>
			<div class="bg-surface-white px-4 pb-6 pt-5 sm:px-6">
				...
				<p class="mb-5 text-p-base text-ink-gray-5">
					{{
						__(
					...
					<br />
					<code
						class="rounded bg-surface-gray-2 px-1 my-1 py-0.5 text-p-sm text-ink-gray-8"
					>
				...
				<div class="flex flex-col overflow-hidden">
					<div class="relative flex max-h-[20rem] flex-col overflow-y-auto">
						<div
							class="sticky top-0 flex gap-x-2 border-b bg-surface-white py-2 text-p-sm font-medium text-ink-gray-5"
						>
						...
						<div v-if="variables.length === 0" class="flex justify-center py-8">
							<span class="text-p-sm text-ink-gray-3">No variables added</span>
						</div>
					</div>
