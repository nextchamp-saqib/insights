...
<template>
	<div
		v-if="workbook"
		class="relative flex flex-shrink-0 items-center overflow-x-auto bg-surface-white"
	>
		<div class="flex">
			<button
			...
			>
				...
				<XIcon
					class="ml-2 h-3.5 w-3.5 cursor-pointer text-ink-gray-4 transition-all hover:text-ink-gray-8"
